...
describe('Modal Window Component', () => {
    ...
    it('should initialize properly in the standard case', () => {
        ...
        expect(modalInstance.widthPercentage).toBeUndefined();
        expect(modalInstance.maxWidthPixels).toBeUndefined();
    ...
    it('should properly handle the modalIndexChanged event', () => {
        let modal2 = new ModalWindowComponent(modalManagerService);
